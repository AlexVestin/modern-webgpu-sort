...
#ifndef LYRA_UTILS_WGPUHELPERS_H_
#define LYRA_UTILS_WGPUHELPERS_H_
...
wgpu::Buffer CreateBufferFromData(const wgpu::Device& device,
                                  wgpu::BufferUsage usage,
                                  std::initializer_list<T> data, const char* label) {
    return CreateBufferFromData(device, data.begin(), uint32_t(sizeof(T) * data.size()), usage, label);
}
...
struct ComboRenderPassDescriptor : public wgpu::RenderPassDescriptor {
  public:
    ...
    std::array<wgpu::RenderPassColorAttachment, dawn::kMaxColorAttachments> cColorAttachments;
...
wgpu::PipelineLayout MakeBasicPipelineLayout(const wgpu::Device& device,
                                             ...
                                             uint32_t bindGroupLayerCount = 1,
...
const wgpu::BindGroup MakeBindGroup(
        const wgpu::Device& device,
